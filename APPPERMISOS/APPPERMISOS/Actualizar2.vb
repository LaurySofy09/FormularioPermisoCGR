...
Public Class Actualizar2
    ...
    Sub modificar()
        Dim cadena As String = "Update LSDREGISTER set id = '" & TextBox2.Text & "', direccion = '" & ComboBox1.Text & "', departamento = '" & ComboBox2.Text & "', Seccion = '" & ComboBox3.Text & "', tipopermiso = '" & ComboBox4.Text & "', otros = '" & TextBox3.Text & "', fechainicial = '" & DateTimePicker6.Value.ToShortDateString & "', fechafinal = '" & DateTimePicker2.Value.ToShortDateString & "', fechaactual = '" & DateTimePicker5.Value.ToShortDateString & "', rango = '" & CheckBox1.Checked & "', horainicial = '" & DateTimePicker3.Value.ToLongTimeString & "', horafinal = '" & DateTimePicker4.Value.ToLongTimeString & "', horatotal = '" & MaskedTextBox1.Text & "', jefe_supervisor = '" & TextBox5.Text & "', observacion = '" & TextBox6.Text & "' where nombre = '" & TextBox1.Text & "' and fechainicial = '" & DateTimePicker1.Value.ToShortDateString & "'"
        Try
